...
- `MEDBOOK_ROOT=books/{{BOOK_SLUG}} .venv/bin/python scripts/generate_research_checklist.py 001`
...
- `MEDBOOK_ROOT=books/{{BOOK_SLUG}} .venv/bin/python scripts/build_chapter_pack.py 001`
- `MEDBOOK_ROOT=books/{{BOOK_SLUG}} .venv/bin/python scripts/run_chapter_qa.py 001`
