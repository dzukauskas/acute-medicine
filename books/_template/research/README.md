...
Jei source skyriuje yra UK / Australia signalų ar rinkos-specifinių vaistų informacijos, `research` faile privalo būti aiškus LT/EU-first sprendimas, kitaip `build_chapter_pack.py` turi hard-fail'inti.
